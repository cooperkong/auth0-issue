...
Configure the application with details of the Auth0 domain and client ID of your application. Locate the `/app/src/main/res/values/strings.xml.example` file, rename to `strings.xml` and replace the placeholder `Wt4lQo2xnLjo8if5ZpqxtPaLhmjX28Yf` and `dev-hbpomk2ep6n537om.us.auth0.com` values with your application's client ID and domain.
...
<resources>
    ...
    <string name="com_auth0_client_id">Wt4lQo2xnLjo8if5ZpqxtPaLhmjX28Yf</string>
    <string name="com_auth0_domain">dev-hbpomk2ep6n537om.us.auth0.com</string>
